...
export async function generateStaticParams() {
  return getIngredients().map((ingredient) => ({
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `${ingredient.name} Recipes`,
    description: `Browse delicious recipes made with ${ingredient.name}.`,
  };
}
        ...
        <AppContainer>
          <div className="mb-10">
            ...
            <p className="mt-3 text-gray-600">
              Browse all recipes that include{" "}
